<template>
    <div class="common-layout">
            ...
            <el-aside width="240px" :style="{ height: windowHeight + 'px' }">
                ...
                <div v-show="showRightMenub">
                    <ul id="menub" class="right-menu right-menu-height-max">
                        ...
                        <li class="menu-item" @click="ReferenceTem">
        ...
        >
            ...
            <template #footer>
                <span class="dialog-footer">
                 <el-button @click="resetForm('ruleForm_a')" class="buttonRight">重 置</el-button>
                <el-button type="primary" @click="addTem">添 加</el-button>
                </span>
            </template>
        </el-dialog>
        <el-dialog
        ...
        >
            <div class="note">
                <el-form :model="ruleForm_e" ref="ruleForm_e" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="序号" prop="name" class="form" required>
                        <el-input v-model="ruleForm_e.name" placeholder="ruleForm_e.name"></el-input>
                    </el-form-item>
                    <el-form-item label="描述" class="form" prop="desc" required>
                        <el-input placeholder="ruleForm_e.desc" v-model="ruleForm_e.desc"></el-input>
                    </el-form-item>
                </el-form>
            </div>
            <template #footer>
...
export default {
    ...
    methods: {
        dblclick(row) {
            ...
            this.ruleForm_e.id = row.id
            this.ruleForm_e.name = row.name
            this.ruleForm_e.desc = row.desc
        },
        updataItem() {
            this.temDialog_d = false
            this.temData.temTableData.map((x) => {
                if(x.id === this.ruleForm_e.id) {
                    x.name = this.ruleForm_e.name
                    x.desc = this.ruleForm_e.desc
                }
            })
        },
